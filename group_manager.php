...
{
   $group_name = $_POST['group_edit_name'];
...
<div class="row">
   <div class="col-md-12"> <h4 class="page-title">Group Manager  <a data-toggle="modal" href="#basic" class="pull-right btn default red">Add New Group</a></h4>  </div>
   <div class="modal fade" id="basic" tabindex="-1" role="basic" aria-hidden="true">
          ...
          <div class="col-md-12">             
           ...
           <div class="col-md-12" style=""> 
                 <div class="form-group">
                  Group Type
                <input type="radio" selected name="group_type" value="Public" > Public
           ...
           <div class="col-md-10" style=""> 
            ...
            <div class="form-actions"><div class="row">
                    <div class="col-md-offset-5 col-md-12">
                      <button class="btn red" type="submit" style="margin:30px 0 20px 0">Save Group</button>
        ...
        <div class="scroller" style="height:200px">
          <table class="table table-hover" id="sample_2">
                  ...
                  while ($detail = mysqli_fetch_assoc($groupList)) 
                     ...
                     ?>
								...
								<tr style="cursor: pointer;">
									<td onclick="group_message(<?php echo $detail['group_id']; ?>)">
										<?php echo $detail['group_name']; ?> 
									</td>
									<td onclick="group_message(<?php echo $detail['group_id']; ?>)">
										 <?php echo $detail['group_detail']; ?> 
									</td>
                    ...
                    Message </a></td>
									<td>
										<a data-toggle="modal" href="#EditGroup" class="label label-sm label-success" onclick="group_detail(<?php echo $detail['group_id']; ?>)">
										EDIT </a>
									</td>
									<td>
         ...
         <div class="col-md-6"><div class="portlet light ">
                  <div class="portlet-title">
                     <div class="caption">
                        ...
                        <span class="caption-subject font-red-sunglo bold uppercase" id="group_caption"> Group Message </span>
                     </div>
                  ...
                  <div class="portlet-body"><div class="scroller" style="height: 341px;" data-always-visible="1" data-rail-visible1="1"><ul class="chats" id="group_comments">
                        ...
                        <input type="hidden" name="group_message_id" id="group_message_id">
                          <div class="input-cont">
                            <input class="form-control" id="group_message_text" placeholder="Type a message here..." type="text">
                          </div>
                          <div class="btn-cont">
                            <span class="arrow">
                            </span>
                            <button class="btn red icn-only" onclick="group_send_message();">
         ...
         <div class="col-md-6"> <div class="portlet light ">
                  <div class="portlet-title">
                     <div class="caption">
                        ...
                        <span class="caption-subject font-red-sunglo bold uppercase" id="total_members"> Members</span>
                     </div>
